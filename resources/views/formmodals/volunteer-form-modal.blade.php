        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 id="title" style="margin-top: 15px;">{{ $messages['volunteer_form_title'] }}</h3>
                </div>
                <!-- list of text field inputs and check boxes  -->
                <div class="modal-body">
                    <div id="inputs" class="container-fluid volunteer-inputs">
                        <span>{!! $messages['volunteer_form_instructions'] !!}</span>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <span>
                                    {!! $messages['volunteer_confirmation'] !!}
                                </span>
                    ...
                    <div id="loading-info" class="loading-info" hidden>
                        <h3 class="text-light text-center"> {!! $messages['volunteer_loading'] !!}</h3>
